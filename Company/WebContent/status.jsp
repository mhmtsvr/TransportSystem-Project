...
%>
            ...
            <div id="gbox-bg">
             ...
             <h2>WELCOME TO OUR TRUCK TRACKING COMPANY</h2>
				<marquee dir="ltr"><font style="color: navy;">This is High Performance Transportation</font></marquee>             
             <br/>
              <% 
              	
                Class.forName("oracle.jdbc.driver.OracleDriver");
	            Connection con= DriverManager.getConnection("jdbc:oracle:thin:@192.168.0.24:1521:xe","system","redhat");
                PreparedStatement ps= con.prepareStatement("Select tmodel,tno,tfrom,tto from tinstall order by id desc ");
